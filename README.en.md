...
| `tools/` | maintenance helpers: `agent.ps1` (launch a role-scoped agent), `audit_boundary.py` (dependency audit), `apply_patch.py` |
...
| --- | --- | --- |
| orchestrator | root docs, `openspec/**`, `docs/**`, `tools/**` | writable |
