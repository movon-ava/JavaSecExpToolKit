...
public final class ConfigController {
    ...
    public void resetForm() {
        ...
        form.analyzeBackendHome.setText(config.getProperty("analyze_backend_home",
                config.getProperty("analyze_engine_jar", "")));
        ...
        form.analyzeJsonExport.setSelected(flagFrom("analyze_json_export", true));
        form.analyzeJsonDir.setText(config.getProperty("analyze_json_dir", ""));
    ...
    public void save() {
        ...
        config.setProperty("analyze_backend_home", form.analyzeBackendHome.getText().trim());
        ...
        config.setProperty("analyze_json_export", String.valueOf(form.analyzeJsonExport.isSelected()));
        config.setProperty("analyze_json_dir", form.analyzeJsonDir.getText().trim());
